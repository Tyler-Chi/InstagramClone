...
post1 = Post.create(description: 'trees',img_url: 'https://upload.wikimedia.org/wikipedia/commons/a/a3/Nature-View.jpg', authorId: user1.id)
...
post3 = Post.create(description: 'stars',img_url: 'https://static.pexels.com/photos/33688/delicate-arch-night-stars-landscape.jpg', authorId: user1.id)

post4 = Post.create(description: 'wheat',img_url: 'https://get.pxhere.com/photo/landscape-nature-grass-branch-light-sky-sun-fog-sunrise-sunset-mist-field-grain-sunlight-morning-dawn-summer-dusk-evening-harvest-autumn-fields-mood-arable-atmospheric-phenomenon-grass-family-642150.jpg', authorId: user1.id)

post5 = Post.create(description: 'droplets',img_url: 'https://static.pexels.com/photos/8486/water-rain-raindrops-drops.jpg', authorId: user1.id)
